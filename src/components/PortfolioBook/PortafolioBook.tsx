...
pages.forEach((page) => {
  useTexture.preload(`assets/textures/${page.front}.png`);
  useTexture.preload(`assets/textures/${page.back}.png`);
  useTexture.preload(`assets/textures/roughness.png`);
});
...
const Page = ({
  ...
  useFrame((_, delta) => {
    ...
    if (Array.isArray(materials) && materials[4] && materials[5]) {
  ...
  useEffect(() => {
    ...
    const goToPage = () => {
      setDelayedPage((delayedPage) => {
        ...
        return delayedPage; // Ensure a number is always returned
      });
    };
    goToPage();
    return () => {
