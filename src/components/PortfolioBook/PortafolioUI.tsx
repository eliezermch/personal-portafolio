...
const pictures = ['bike-img', 'polyjoule-img', 'fresco-design-img'];
...
export const UI = () => {
  ...
  return (
    <>
      <main className=" pointer-events-none select-none z-10 fixed min-h-screen  inset-0  flex justify-between flex-col">
        <a
